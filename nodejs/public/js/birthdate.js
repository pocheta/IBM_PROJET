...
function roll(add) {
    ...
    const id = setInterval(changeImg, 200)
...
function changeImg() {
    document.getElementById('die-1').setAttribute("src", images[Math.floor(Math.random() * 6)]);
    document.getElementById('die-2').setAttribute("src", images[Math.floor(Math.random() * 6)]);
}
